...
execute if score #temp shp_data matches 2147483647 run tellraw @s [{"text":"- ","color":"gray"},{"nbt":"temp[-1].name","storage":"minecraft:shp_speedrun_coursedata","color":"white"},{"text":": No data","color":"gray"}]
